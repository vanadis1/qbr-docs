...
const FeatureList = [
  {
    ...
    description: (
      <>
        QBRCore was built with developers in mind! Offering easy configuration,
  ...
  },
  {
    ...
    description: (
      <>
        QBRCore comes pre-loaded with many unique scripts that will give you the tools needed
